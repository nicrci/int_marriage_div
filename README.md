...
During the data cleaning process, we organized the monthly .csv files of marriage and divorce data for the 3 targeted years into separate folders named "2021", "2022", and "2023". Each folder contains .csv files for marriage and divorce data.
