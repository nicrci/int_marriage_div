...
To begin, download the raw data on marriage and divorce termination data from the Department of Household Registration available on the Open Government Data platform at https://data.gov.tw/dataset/32969. They are .csv files. Each files contains column name and we changed it for a better understanding as below.
...
Folder named "Raw Data" contains marriage and divorce data from year 2021 to 2023
FB_All_candidates.csv contains all the Facebook posts from all the candidates in the period 2022/02/11 to 2022/11/27. master_candidates_posts.csv is the preprocessed version that is adjusted for the exact campaign period for each candidate. candidates_info.xlsx contains additional information about each candidate (e.g. city, party, english name, etc.). Lastly, election_bulletin.xlsx contains all of the candidates' election bullitins. These played an important role in compiling our keyword list.

DataCleaning_divorce_marriage_2021.R, DataCleaning_divorce_marriage_2022.R, and DataCleaning_divorce_marriage_2023.R that in the folder called "Data Cleaning and Merge" contains code for data cleaning and merge.

Datamerge_visulization_2021_2023.R contains all of the data visualization which are plots for the Marriage and Divorce Count by Nationality Group, The Divorce and Marriage Ratio of Different Nationalities in Taiwan's international marriage, Divorce Gender Ratio by Nationality, Marriage Gender Ratio by Nationality, and Average Marriage and Divorce Rate Distrubution Map (more details in Visualiztion Methodology section).
